...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QRect(10, 0, 401, 781))
        self.tab = QWidget()
        ...
        self.gridLayout.addWidget(self.mostrar_pushButton, 22, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.agregar_inicio_pushButton, 21, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.salida, 19, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.agregar_final_pushButton, 20, 0, 1, 1)
