...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QRect(10, 10, 441, 681))
        ...
        self.gridLayout.addWidget(self.red_spinBox, 16, 0, 1, 1)

        self.green_spinBox = QSpinBox(self.groupBox)
        self.green_spinBox.setObjectName(u"green_spinBox")
        self.green_spinBox.setMaximum(255)

        self.gridLayout.addWidget(self.green_spinBox, 18, 0, 1, 1)

        self.agregar_inicio_pushButton = QPushButton(self.groupBox)
        self.agregar_inicio_pushButton.setObjectName(u"agregar_inicio_pushButton")

        self.gridLayout.addWidget(self.agregar_inicio_pushButton, 24, 0, 1, 1)

        self.agregar_final_pushButton = QPushButton(self.groupBox)
        self.agregar_final_pushButton.setObjectName(u"agregar_final_pushButton")

        self.gridLayout.addWidget(self.agregar_final_pushButton, 23, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.velocidad_lineEdit, 12, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.blue_spinBox, 20, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.salida, 22, 0, 1, 1)

        self.mostrar_pushButton = QPushButton(self.groupBox)
        self.mostrar_pushButton.setObjectName(u"mostrar_pushButton")

        self.gridLayout.addWidget(self.mostrar_pushButton, 25, 0, 1, 1)
        ...
        self.menubar.setGeometry(QRect(0, 0, 457, 21))
